	...
	<div style="max-width:600px;width:100%;margin:0 auto;padding:30px 0;">
		<div style="background:#fff;padding:0 0 20px 0;box-shadow:0 0 12px rgba(0,0,0,.15);">
			<div style="text-align:center;padding:40px 0;background:#9b0d28;">
				<p style="color:#fff;font-size:24px;margin:0;padding:0;text-transform:uppercase;font-weight:500;">Дякуємо, що ви залишили заявку. </p>
			</div>
			<div style="padding:30px 20px;">
				<div style="background:#f6f6f6;padding:40px 20px;">
					<h3 style="font-size:32px;color:#212121;font-weight:600;margin:0;">Ми звяжемось з вами в ближній час!</h3>
					<p style="font-size:14px;color:#242424;font-weight:400;">
					{{ $demo->name }} це означає що ви з нами.
					</p>

				</div>
			</div>
			<div style="padding:20px;">
			<p style="color:aaa;font-size:14px;margin:0px;display:inline-block;">Дякуємо за заявку<br><b>{{ $demo->sender }}</b></p>
			</div>
		</div>
	</div>
</body>
