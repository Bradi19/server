        ...
        <div class="row">
            <div class="col-3">
                <nav class="nav nav-tabs|pills flex-column">
                    <a class="nav-link active" data-target='add' href="/admin/news/add">Add</a>
                </nav>
            </div>
            <div class="col-9">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <a class="nav-link" data-target='remove'
                                                href="/admin/news/remove">Remove</a>
                                        </div>
                                        <div class="col-6">
                                            <a class="nav-link" data-target='edit' href="/admin/news/edit">Edit</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<div class="modal_window">
    <div class="block__modal">
        ...
        <div class="inputs">
            ...
            <form method="POST" name="dols" url="/admin/news" class="forms" id="forms">
                @csrf
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-6">
                            <label for="validationCustom01" class="form-label">Language</label>
                            <input type="date" class="form-control" min="{{ $toDay }}" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" name="datePublish" value="" />
                            <div class="valid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            <textarea type="text" class="form-control " height="400" name="body" id="validationCustomUsername"
                                aria-describedby="inputGroupPrepend" value=''></textarea>
